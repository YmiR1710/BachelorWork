...
void CopyPasteUtils::paste_unit(QFileInfo copy_info, QFileInfo chosen_info, bool isFolder) {
    if (isFolder) {
        paste_folder(copy_info, chosen_info);
    } else {
        paste_file(copy_info, chosen_info);
    }
}

void CopyPasteUtils::paste_file(QFileInfo copy_info, QFileInfo chosen_info) {
...
void CopyPasteUtils::paste_folder(QFileInfo copy_info, QFileInfo chosen_info) {
